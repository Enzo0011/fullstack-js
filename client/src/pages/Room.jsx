        ...
        <div className="flex">
          ...
          <div style={{ minWidth: "425px" }} className="w-1/2 border-2 h-screen relative">
            <div className="flex justify-between items-center px-4 h-7/100 bg-white shadow-sm">
              ...
              <button className="bg-red-500 text-white px-4 py-1 rounded text-sm hover:opacity-80" onClick={leaveRoom}>Quitter</button>
            </div>
            ...
            <div className="px-4 h-1/10 bg-white flex justify-between items-center">
              ...
              <button type="button" onClick={sendMessage} className="bg-blue-500 text-white px-8 py-1.5 rounded-lg">Envoyer</button>
            </div>
          </div>
